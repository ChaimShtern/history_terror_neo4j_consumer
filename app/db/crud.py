...
def merge(node_one_params: dict, node_one_labels: List[str], node_two_params: dict, node_two_labels: List[str],
          rel: str, rel_params: dict):
    ...
    query = f"""
            ...
            return rel
            """
    return single_query(query=query, params={**node_one_params_with_new_keys, **node_two_params_with_new_keys,
                                             **rel_params_with_new_keys})
